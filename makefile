...
RUNFLAGS_LSH=-o lsh_output.txt  -k 4 -L 6 -N 6 -R 450           -i $(INPUT_FILE) -q $(QUERY_FILE)
RUNFLAGS_CUB=-o cube_output.txt -k 5 -M 10 -N 6 -R 450 -probes 3 -i $(INPUT_FILE) -q $(QUERY_FILE)
